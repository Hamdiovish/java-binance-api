...
public class BinanceSymbol {
    ...
    public BinanceSymbol(String symbol)  throws BinanceApiException {
        ...
        if (!symbol.endsWith("BTC") && !symbol.endsWith("ETH")&& !symbol.endsWith("BNB") && !symbol.endsWith("USDT") && !symbol.endsWith("TUSD")  && !symbol.endsWith("PAX") ) {
            throw new BinanceApiException("Market Symbol should be ending with BTC, ETH, BNB, USDT, TUSD or PAX. Example: BQXBTC. Provided: " + symbol);
        }
